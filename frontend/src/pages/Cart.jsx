        ...
        <div>
            ...
            <div className='py-10 px-20'>
                ...
                <div className='mt-10 w-100 shadow-2xl p-3 rounded-2xl'>
                    ...
                    <button 
                        onClick={() => { cart.length === 0 ? toast.error("Empty Cart") : navigate("/order") }} 
                        className='bg-blue-950 w-50 h-7 text-white rounded-md cursor-pointer my-3 hover:w-60 duration-300'
                    >
                        Order Now
                    </button>
                </div>
